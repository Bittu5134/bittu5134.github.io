# Audio Track Attributions & Licensing

This document provides accurate attribution, licensing, and creator details for audio assets used in the Retro Lo-Fi Cassette Player on [bittu.dev](https://bittu.dev).
...
| :--- | :--- |
| **Track Title** | Miku |
| **Primary Artist** | [Anamanaguchi](https://soundcloud.com/anamanaguchi) |
| **Featured Vocalist** | Hatsune Miku (初音ミク) |
...
| **Usage Context** | Used strictly for non-commercial personal portfolio cassette deck preview with external streaming link back to the official SoundCloud release. |
...
- **Vocals**: Nomico
- **Original Composition**: ZUN (Team Shanghai Alice - Touhou Project: Lotus Land Story)
...
- **Streaming Link**: [SoundCloud: Caramelldansen](https://soundcloud.com/dajukeboxguy/caramell-caramelldansen-english-version)

---

## Direct Playlist Link
All tracks are curated from the public SoundCloud playlist:  
🔗 **[https://soundcloud.com/bittu-162282868/sets/portifolio](https://soundcloud.com/bittu-162282868/sets/portifolio)**
